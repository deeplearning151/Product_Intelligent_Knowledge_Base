...
def step1_create_hyde_doc(rewritten_query):
    """
    调用模型根据问题，生成一份答案
...
def step2_search_embedding_hyde(rewritten_query, hyde_doc, item_names):
    """
...
def node_search_embedding_hyde(state):
    ...
    hyde_doc = step1_create_hyde_doc(rewritten_query)
    # 3. 问题+答案，进行向量检索（混合检索）
    resp = step2_search_embedding_hyde(rewritten_query,hyde_doc,item_names)
